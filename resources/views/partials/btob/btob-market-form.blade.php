<div class="contact-form">
    ...
    <div class="wrap">
        <h2 id="contact-goal">Je souhaite acheter une b:bot</h2>
        <form class="contact-form-form">
            ...
            <div class="contact-form-row">
                <input required class="contact-form-field" type="text" placeholder="Ville*" name="city" id="city"/>
                <input required class="contact-form-field" type="text" placeholder="Nb moy. de passages en caisse/jour*" name="nb_customers" id="nb_customers"/>
            </div>
