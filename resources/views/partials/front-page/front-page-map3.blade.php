<section class="frontpage-map frontpage-map3" id="frontpage-map">
    <div class="wrap">
     ...
     <div class="map-wrapper">
        ...
        <div class="map" id="map3" style="width: 1024px; height:500px;">
            <div class="frontpage-map-overlay frontpage-map3-overlay">
    ...
    <script>
        ...
        function haversine_distance(mk1, mk2) {
            ...
            document.querySelector(".frontpage-map3-overlay .cross").addEventListener("click", () => {
            document.querySelector(".frontpage-map3-overlay").classList.remove("frontpage-map-overlay-visible")
        })
        ...
        geocoder3.on('result', function(e) {
            let distancesArray = []
