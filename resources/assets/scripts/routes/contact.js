...
export default {
    ...
    initFormSending() {
      document.querySelector('.contact-form-form').addEventListener('submit', (e) => {
        ...
        const targetEmail = document.querySelector('#contact-goal').dataset.email || 'info@b-bot.com'
        console.warn('targetEmail', targetEmail)
    ...
    initListClickListener() {
        document.querySelectorAll('.choices-list li').forEach(item => {
            item.addEventListener('click', (e) => {
                ...
                document.querySelector('.contact-form h2').dataset.email = e.target.dataset.email;
